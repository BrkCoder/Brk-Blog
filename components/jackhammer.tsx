...
const Jackhammer = () => {
    ...
    return (
        <div className={styles.jackhammer}>
            ...
            <div id="jackhammerTitle">Our Website is Under Construction.</div>
                    ...
                    <g>
                        ...
                        >
                            ...
                            <text
                                ...
                                textAnchor="middle"
                                transform="matrix(1 0 0 1 50 77)"
                            >
                                {daysLeft}
                            </text>
                            <text
                                transform="matrix(1 0 0 1 50 96)"
                        ...
                        >
                            ...
                            <text
                                ...
                                className={styles.jhcount}
                                textAnchor="middle"
                                transform="matrix(1 0 0 1 150 77)"
                            >
                                {hoursLeft}
                            </text>
                            <text
                        ...
                        >
                            ...
                            <text
                                ...
                                className={styles.jhcount}
                                textAnchor="middle"
                                transform="matrix(1 0 0 1 250 77)"
                            >
                                {minutesLeft}
                            </text>
                            <text
                                transform="matrix(1 0 0 1 250 96)"
                                className={styles.jhtime}
                            >
                                minutes
                            </text>
                        ...
                        >
                            ...
                            <text
                                ...
                                className={styles.jhcount}
                                textAnchor="middle"
                                transform="matrix(1 0 0 1 350 77)"
                            >
                                {secondsLeft}
                            </text>
                            <text
                                transform="matrix(1 0 0 1 350 96)"
                                className={styles.jhtime}
                            >
                                seconds
                            </text>
